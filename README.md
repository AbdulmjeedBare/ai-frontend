...
راجع ملف [API_INTEGRATION.md](./API_INTEGRATION.md) للتفاصيل الكاملة.

**Endpoints المطلوبة:**

1. `POST /predict-image` - تحليل الصور
2. `POST /predict-text` - تحليل النصوص
...
مشروع تخرج - AI Security Platform

**التقنيات:** React + TypeScript + AI/ML

---

## 📄 الترخيص

هذا المشروع تعليمي لأغراض العرض في المعارض والمنافسات.

---

## 🙏 شكر خاص

- Figma Make - بيئة التطوير
- Anthropic Claude - مساعد البرمجة
- Open Source Community

---

**صُنع بـ ❤️ للأمن السيبراني**
